...
package commic.hy.suzumiya.hdimage.util;
...
import static commic.hy.suzumiya.hdimage.datasource.BitmapDataSource.ASSET_SCHEME;
import static commic.hy.suzumiya.hdimage.datasource.BitmapDataSource.FILE_SCHEME;
import static commic.hy.suzumiya.hdimage.state.Orientation.ORIENTATION_0;
import static commic.hy.suzumiya.hdimage.state.Orientation.ORIENTATION_180;
import static commic.hy.suzumiya.hdimage.state.Orientation.ORIENTATION_270;
import static commic.hy.suzumiya.hdimage.state.Orientation.ORIENTATION_90;
import static commic.hy.suzumiya.hdimage.state.Orientation.ORIENTATION_EXIF;
            ...
            if (cursor != null) {
                if (cursor.moveToFirst()) {
                    ...
                    if (orientation == ORIENTATION_0) {
                        ...
                        Logger.w("Unsupported orientation: " + orientation);
                    }
                }
                cursor.close();
            }
        ...
        if (sourceUri.startsWith(FILE_SCHEME)) {
            try {
                ...
                if (orientationAttr == ExifInterface.ORIENTATION_NORMAL ||
                    ...
                    Logger.w("Unsupported EXIF orientation: " + orientationAttr);
                }
            } catch (IOException e) {
                e.printStackTrace();
                Logger.w("Could not get EXIF orientation of image");
            }
