...
import commic.hy.suzumiya.hdimage.util.Preconditions;
...
public class AnimationBuilder {
    ...
    public ValueAnimator build(){
        ...
        animator.setScaleInterpolator(mScaleInterpolator == null ? HDImageView.DEFAULT_INTERPOLATOR : mScaleInterpolator);
        animator.setTranslateInterpolator(mTranslateInterpolator == null ? HDImageView.DEFAULT_INTERPOLATOR : mTranslateInterpolator);
